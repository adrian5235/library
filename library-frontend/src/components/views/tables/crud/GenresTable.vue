<template>
  ...
  <div class="flex justify-content-center">
    <div class="card">
      <Toolbar class="mb-4">
        <template #start>
          <Button label="Add" icon="pi pi-plus" severity="success" @click="genreDialog=true" outlined />
        </template>
      </Toolbar>
      ...
      removableSort v-model:filters="filters" filterDisplay="row" :globalFilterFields="['name']">
        ...
        <template #empty> Could not find any genres </template>
